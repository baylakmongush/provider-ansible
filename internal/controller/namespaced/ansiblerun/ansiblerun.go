...
import (
	...
	v1alpha1 "github.com/crossplane-contrib/provider-ansible/apis/namespaced/v1alpha1"
...
// SetupOptions contains settings specific to the namespaced AnsibleRun controller.
...
func (c *connector) Connect(ctx context.Context, cr *v1alpha1.AnsibleRun) (managed.TypedExternalClient[*v1alpha1.AnsibleRun], error) { //nolint:gocyclo
	...
	// ProviderConfig is looked up in the same namespace as the AnsibleRun.
